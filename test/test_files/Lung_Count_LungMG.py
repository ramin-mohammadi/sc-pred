...
# raw gene count data
count = pd.read_csv('C:/RaminMohammadi/TestingCreatedPackage/Datasets_Mostafa/Lung_Tabula_Muris/Lung_DF.csv')
...
count_meta = pd.read_csv('C:/RaminMohammadi/TestingCreatedPackage/Datasets_Mostafa/Lung_Tabula_Muris/Lung_Labels.csv')
...
HGT.to_csv("cell_type_predictions_LungCOUNT_Lung_MG.csv")
#------------------------
